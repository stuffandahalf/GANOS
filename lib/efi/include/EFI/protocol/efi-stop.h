#ifndef __EFI_PROTOCOL_STOP_H
#define __EFI_PROTOCOL_STOP_H	1
...
typedef EFI_STATUS (EFIAPI *EFI_TEXT_SET_CURSOR_POSITION) (
	IN EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL *This, IN UINTN Column,
	IN UINTN Row);
...
#define BOXDRAW_DOUBLE_DOWB_RIGHT		0x2554
